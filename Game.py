...
#It implements the game board and finding an empty space when initiating the game
...
class Game:
    ...
    def find_free_space(self):
        ...
        if [x, y] not in self.player.position:
            return x, y
        else:
    ...
    def display_ui(self):
        ...
        if self.player.color == "green":
            color = "Green"
        text_score = myfont.render(color + ' Snake Score: ' + str(self.player.score), True, (0, 0, 0))
        text_highest = myfont.render('Record: ' + str(self.player.record), True, (0, 0, 0))
        avg = self.player.total_score / (self.player.deaths + 1)
        text_avg = myfont.render('Avg: ' + str(round(avg)), True, (0, 0, 0))
        self.gameDisplay.blit(text_score, (35, 440 + 20))
        self.gameDisplay.blit(text_highest, (230, 440 + 20))
        self.gameDisplay.blit(text_avg, (340, 440 + 20))
